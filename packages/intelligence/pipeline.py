...
class IntelligencePipeline:
    ...
    def process_context(self, context_obj: Dict[str, Any], is_update: bool = False, existing_context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        ...
        if is_update and existing_context:
            context_obj = self.memory_manager.apply_update(existing_context, context_obj)
