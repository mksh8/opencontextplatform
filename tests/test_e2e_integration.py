...
class TestEndToEndIntegration(unittest.TestCase):
    ...
    def test_full_ingestion_lifecycle(self):
        ...
        raw_payload = {
            ...
            "body": "The LanceDB instance crashes on queries > 1GB. Please investigate."
        }
        ...
        # In a real environment, the context_obj would now be sent to the ProviderFactory to write to ArcadeDB.
