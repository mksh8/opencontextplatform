...
class MemoryEngine:
    ...
    Persists and manages session, episodic, and semantic memory using the unified database.
    """
    ...
    def save_memory(self, context_obj: Dict[str, Any]) -> str:
        ...
        if "id" not in context_obj or "tenant_id" not in context_obj or "type" not in context_obj:
