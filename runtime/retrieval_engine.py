...
class RetrievalEngine:
    ...
    def search(self, tenant_id: str, query: str, query_embedding: List[float], hybrid_weight: float = 0.5) -> List[Dict[str, Any]]:
        """
    ...
    def _rank_results(self, results: List[Dict[str, Any]], query: str, weight: float) -> List[Dict[str, Any]]:
