"""Database initialization and seeding routines."""
...
def init_database_schemas(_engine: Engine):
    """
    ...
    with Session(engine) as session:
        ...
        if not (admin_email and admin_password):
            if sys.stdin.isatty():
                ...
                print("=" * 50)
                admin_name = (
                    input("Platform Owner Name [System Administrator]: ")
        ...
        if admin_email and admin_password:
            ...
            platform_owner_role = (
                session.query(Role).filter_by(name="Platform Owner").first()
            )
