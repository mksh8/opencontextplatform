...
class CollectionService:
    def get_collections(self, org_id: str) -> List[CollectionItem]:
        ...
        return [
            CollectionItem(
                ...
                description="User mentioned they prefer comprehensive explanations with practical examples over brief answers.",
                tag="Documentation",
            ...
            CollectionItem(
                ...
                description="Decided to use JWT tokens with refresh token rotation for better security.",
                tag="Engineering",
            ...
            CollectionItem(
                ...
                description="Comparing LanceDB vs Pinecone vs Milvus for our specific use case.",
                tag="Architecture",
