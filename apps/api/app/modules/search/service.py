"""Search service layer for universal, semantic, graph, and hybrid search methods."""
...
class SearchService:
    """Service layer managing search execution across vector, graph, and hybrid modes."""

    async def search_universal(
        self, _request: UniversalSearchRequest, _engine: RetrievalEngine
    ) -> UniversalSearchResponse:
            ...
            results=[
                {
                    ...
                    "snippet": (
                        "The core event routing system is designed to handle "
    ...
    async def search_semantic(
        self, _request: SemanticSearchRequest, _engine: RetrievalEngine
    ) -> SemanticSearchResponse:
        ...
        return SemanticSearchResponse(
            results=[
                ...
                },
                {
                    ...
                    "tags": [],
                    "snippet": (
                        "We discussed how we should handle the OAuth flow for 3rd "
                        "party providers..."
                    ),
                    "timestamp": "",
                    "metadata": {},
    ...
    async def search_graph(
        self, _request: GraphSearchRequest, _engine: RetrievalEngine
    ) -> GraphSearchResponse:
            ...
            nodes=[
                {
                    "id": "col_eng_specs",
                    "label": "Collection",
                    "properties": {"name": "Engineering Specs", "count": 14230},
                },
                {
                    "id": "ctx_71586e68",
                    "label": "Context",
                    "properties": {"title": "Project Apollo", "source": "API"},
                },
                {
                    "id": "ctx_92401a2c",
                    "label": "Context",
                    "properties": {"title": "Weekly Sync", "source": "Slack"},
                },
            ],
            edges=[
                {
    ...
    async def search_hybrid(
        self, request: HybridSearchRequest, _engine: RetrievalEngine
    ) -> HybridSearchResponse:
            ...
            graph_context=[
                {
                    ...
                    "description": (
                        "Brings in context from the 'Engineering Specs' "
